...
from scalrtools.api import ScalrAPIError, ScalrConnection
...
class TestScalrConnection(unittest.TestCase):
    ...
    def test__read_get_list_servers_response(self):
    ...
    def test__read_get_list_servers_response_bo(self):
        response = open('test/resources/FarmGetDetailsResponse_branchout.xml').read()
        xml = xml_strip(parseString(response))
        response = self.conn._read_get_farm_role_properties_response(xml)
        print 'Got response:', response, len(response)
    ...
    def test__read_get_farm_details_response(self):
        ...
        self.assertEquals(farm_role.farm_role_id, '6150')
        ...
        '''
        #commit #64: get-farm-details splitted into 3 opts: get-farm-details, get-farm-role-properties and list-servers
    ...
    def test__read_list_farms_response(self):
        ...
        self.assertEquals(farm.status, 'Running')
